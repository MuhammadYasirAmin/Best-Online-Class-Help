<?php
    $title = 'Our Services | ';
    $description = 'Best Online Class Helps.com has been working hard to serve students all around the world with the most concrete and appropriate online answers to their academic questions. Our main focus is on providing up-to-date and appropriate solutions to struggling students in their desired subject / course.';
...
<!-- ======= Hero Section ======= -->
  <section id="hero" class="d-flex justify-content-center align-items-center" style="background: url(/assets/img/hero-bg4.jpg) top center no-repeat; background-size: cover;">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
          <div class="col-md-7 col-lg-7 d-flex align-items-center">
          <div>
              <h1>We Provide Online <br>Exam Help </h1>
              <h2>Our exquisite department of examination is well equipped to our students in the time of need when the going gets tough.</h2>
      ...
      <div class="col-md-5 col-lg-5">
          <div class="contact" style="padding: 30px; border-radius: 5px; border: 3px solid #5fcf80;">
               <form method="POST" action="/assets/php/mail.php" class="php-email-form"  style="padding: 30px; border: 3px solid #5fcf80;">
                   <!--<h3 >Order Now & Get 60% Discount.</h3>-->
  ...
  <main id="main">
    ...
    <!--  <div class="container">-->
    <!--    <h2> We Provide Help in Online Exam </h2>-->
    <!--    <p>Our exquisite department of examination is well equipped to assist our students in the time of need when the going gets tough.</p>-->
    <!--  </div>-->
    <!--</div>-->
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content mt-5 pt-5">
            <h3>Let Someone To Take My Online Exam.</h3>
            <p class="font-italic">
                Many of the students who ask us, “Can I pay someone to take my online exam?” are having trouble. They’re near the bottom of their grade pool, and they’re worried that failing will prevent them from progressing in their studies. This is inequitable! Students frequently need to finish exams, and they don’t have the time to devote the same level of attention to the subject as they do to their actual major. Every semester, we assist thousands of students in this situation.
              Examinations are a crucial part of any academic process which are held to discover the true potential of a student, Best Online Class Helps .com provides 
special Recommendation and suggestion to its pupil with crash courses and key notes that are available on our portal for reference. 
The success of our students who took assistance during the online exams has been incredible.<br> At BestOnlineClassHelps.com, we do not promote or encourage any form of plagiarism, BestOnlineClassHelps believes in pure hard work, focus and dedication.
            </p>
            <!--<ul>-->
              ...
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  ...
                  <p>
                    ...
                    Its so convinient to have found all the Outcome on the single forum, i have recommended this too many friends already.
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  ...
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                    I always get stuck in Math homework, this is a great space to boost my Mathematical skills and work on my assignments hassle free
                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                  </p>
                </div>
              </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  ...
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                    Chemistry has never been easier than this, the short and crisp explanations have helped me raise my grades D to B+.
                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                  </p>
                </div>
              </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  ...
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                   The tutors are so cooperative, even better than the ones we have at school, no offence to them.
                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                  </p>
                </div>
              </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  ...
                  <p>
                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                    My notes are all complete, my home works are all done, I can’t wait for the summer to begin. Thanks to BOCH it has been a piece of cake
                    <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                  </p>
                </div>
              </div>
